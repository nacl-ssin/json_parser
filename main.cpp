...
void test2(nacl::json_item ji) {
	std::cout << ji.next("other").next(2).next("card").get_element(1) << std::endl;
	std::cout << ji.next("other").next(2).next("card").get_element(2) << std::endl;
	std::cout << ji.next("other").next(2).next("card").next(3).get_value("card1name") << std::endl;
}
